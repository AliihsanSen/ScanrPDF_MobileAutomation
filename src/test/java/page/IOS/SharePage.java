...
public class SharePage extends BasePage {
    ...
    By shareButtonText = By.xpath("//XCUIElementTypeOther[@name=\"Share\"]");
    By shareHeaderText = By.xpath("(//XCUIElementTypeOther[@name=\"Try Scanr Now! Turn your device into a powerful scanner.\"])[2]");
    By scanrText = By.xpath("(//XCUIElementTypeOther[@name=\"Try Scanr Now! Turn your device into a powerful scanner.\"])[2]");
    By settingsBackWidget = By.xpath("(//XCUIElementTypeOther[@name=\"Settings\"])[4]/XCUIElementTypeOther[1]/XCUIElementTypeOther");
    By xClose= By.xpath("//XCUIElementTypeButton[@name=\"Close\"]");
    ...
    public SharePage shareClosed () throws InterruptedException {
        ...
        passLog("10-) Kullanıcı native açılan 'Share' ekranını kapattı.");
        System.out.println("10-) Kullanıcı native açılan 'Share' ekranını kapattı.");
        return this;
    }
    ...
    public SharePage backWidgetClick() throws InterruptedException {
        ...
        backWidgetClick.click();
        passLog("11-) Kullanıcı Settings ekranında 'Back' butonuna tıklar ve home ekranına döndüğünü görüntüler.");
        System.out.println("11-) Kullanıcı Settings ekranında 'Back' butonuna tıklar ve home ekranına döndüğünü görüntüler.");
        return this;
    }

    public SharePage finishTest() throws InterruptedException {
        Thread.sleep(1000);
        passLog("12-) Kullanıcı yapmış olduğu bütün test adımlarının başarılı bir şekilde gerçekleştiğini görüntüler.");
        System.out.println("12-) Kullanıcı yapmış olduğu bütün test adımlarının başarılı bir şekilde gerçekleştiğini görüntüler.");
        return this;
    }
}
